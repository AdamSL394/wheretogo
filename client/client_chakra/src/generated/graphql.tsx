...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', creatorId: number, id: number, points: string, text: string, title: string, updatedAt: string, createdAt: string } };
